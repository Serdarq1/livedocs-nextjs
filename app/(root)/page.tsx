  ...
  return (
   <main className='home-container'>
      ...
      <div className='document-list-container'>
        ...
        {roomDocuments.data.map(({id, metadata, createdAt}: any) => (
          <li key={id} className='document-list-item'>
            <Link href={`/documents/${id}`} className='flex flex-1 items-center gap4'>
              <div className='hidden rounded-md bg-dark-500 p-2 mr-2 sm:block'>
    ...
    <div className='document-list-empty'>
      <Image src='/assets/icons/doc.svg' alt='Document' width={40} height={40} className='mx-auto cursor-pointer' />
      <AddDocumentBtn userId={clerkUser.id} email={clerkUser.emailAddresses[0].emailAddress} />
    </div>
  )}
   </main>
